...
class AboutMethods < Neo::Koan
  ...
  def test_keyword_arguments_with_wrong_number_of_arguments
    ...
    assert_match(/wrong number of arguments \(0 for 1\)/, exception.message) #because we have the wrong number of arguments the method will always default to one argument
  end
