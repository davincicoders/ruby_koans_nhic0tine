...
class AboutMethods < Neo::Koan
  ...
  def test_calling_with_default_values
    ...
    assert_equal [1, 2], method_with_defaults(1, 2) #1 passes in a and b passes in as 2 but 2 is set a symbol
  end
  ...
  def test_calling_with_variable_arguments
    ...
    #argument of a method is an array
  # ------------------------------------------------------------------
