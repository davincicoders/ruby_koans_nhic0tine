...
def score(dice)
  ...
  count_hash = Hash.new(0) #create a new hash instance

  dice.each do |roll| #.each will run through each element in dice
    count_hash[roll] += 1 #sets symbol to numbers and adds 1 to every value found to that symbol
  end
