...
class AboutSymbols < Neo::Koan
  ...
  # against the string value rather than against symbols? The symbols are immutable objects while strings are mutable
  # thus  to compare you must convert them to srings
